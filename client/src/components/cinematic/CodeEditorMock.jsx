...
function EditorLine({ line, lineNum, revealed, isTyping, charCount }) {
  ...
  return (
    <div className="flex items-start gap-0 leading-6 min-h-[24px]">
      <span
        className="select-none w-8 text-right pr-3 text-zinc-600 text-xs font-mono flex-shrink-0"
...
export function CodeEditorMock({ onCommitReady, isActive }) {
  ...
  return (
    <div
      className="editor-chrome w-full h-full flex flex-col"
      style={{ minHeight: 280 }}
    >
      {/* Title bar */}
      <div
        className="flex items-center gap-2 px-4 py-2.5 border-b border-white/[0.06] flex-shrink-0"
      ...
      <div className="flex flex-1 min-h-0">
        {/* Activity bar */}
        <div
          className="w-10 flex-shrink-0 border-r border-white/[0.04] flex flex-col items-center gap-3 pt-3"
        ...
        >
          ...
          <div className="relative p-4 space-y-0.5 overflow-hidden h-full">
            ...
            <div className="flex items-start gap-0 leading-6 min-h-[24px] mb-1">
              <span className="select-none w-8 text-right pr-3 text-zinc-700 text-xs font-mono flex-shrink-0">
                1
              </span>
              <span
            ...
            <div className="flex items-start gap-0 leading-6 min-h-[24px] mb-1">
              ...
              <span
                ...
                style={{ color: "#c586c0" }}
              >
                import <span style={{ color: "#9cdcfe" }}>aiohttp</span>,{" "}
                <span style={{ color: "#9cdcfe" }}>asyncio</span>
              </span>
            </div>
            <div className="h-3" />
      ...
      >
        <div className="flex items-center gap-3 text-zinc-600">
          ...
          <span>
            {done ? (
              <span className="text-emerald-400">● 1 change</span>
            ) : (
              "○ No changes"
            )}
          </span>
